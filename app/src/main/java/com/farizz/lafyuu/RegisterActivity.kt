...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val editTextName: EditText = findViewById(R.id.etFullName)
        val editTextEmail: EditText = findViewById(R.id.etEmail)
        val editTextPassword: EditText = findViewById(R.id.etPassword)
        val editTextPasswordAgain: EditText = findViewById(R.id.etPasswordAgain)
        val buttonSignUp: Button = findViewById(R.id.btnSignUp)
        val textViewSignIn: TextView = findViewById(R.id.tvSignIn)
